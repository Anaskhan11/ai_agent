...
// Create general webhook endpoint (requires auth and credits) - both routes for compatibility
router.post("/", authMiddleware, checkCredits('webhook_creation', 'per_operation', 1), webhooksController.createWebhook);
router.post("/create", authMiddleware, checkCredits('webhook_creation', 'per_operation', 1), webhooksController.createWebhook);
